...
- Name: 05-visual-integrity.spec.ts >> burger menu icon is not rotated
- Location: tests\05-visual-integrity.spec.ts:51:5

# Error details

```
Error: Burger menu icon is rotated (sin of angle = 0.0523)

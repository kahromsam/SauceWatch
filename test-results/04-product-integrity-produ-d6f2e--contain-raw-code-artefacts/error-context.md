...
- Name: 04-product-integrity.spec.ts >> product titles do not contain raw code artefacts
- Location: tests\04-product-integrity.spec.ts:22:5

# Error details

```
Error: Suspicious title: "Test.allTheThings() T-Shirt (Red)"
